...
let img4 = new Image()
img4.src = './mario_luigi_climbing_sprites.png'
...
export class sprites {
	...
	drawClimbing(spriteX, spriteY, spriteWidth, spriteHeight, canvasX, canvasY, canvasWidth, canvasHeight) {
		this.ctx.drawImage(img4, spriteX, spriteY, spriteWidth, spriteHeight, canvasX, canvasY, canvasWidth, canvasHeight)
	}
}